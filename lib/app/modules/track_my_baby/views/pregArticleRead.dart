...
class PregReadsSection extends StatefulWidget {
  final TrackMyPregnancyController controller;

  const PregReadsSection({Key? key, required this.controller}) : super(key: key);

  @override
  State<PregReadsSection> createState() => _PregReadsSectionState();
}

class _PregReadsSectionState extends State<PregReadsSection> {
  ...
  void initState() {
    ...
    articleService.getAllPregArticles(context);
  }

  @override
  Widget build(BuildContext context) {
    return Obx(() {
      final articles = articleService.pregArticleController.articles;
