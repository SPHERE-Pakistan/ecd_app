...
import 'package:babysafe/app/services/stopMusic.dart';
...
class WeeklyDetailsPage extends StatefulWidget {
  final int? currentWeek;

  const WeeklyDetailsPage({Key? key, this.currentWeek}) : super(key: key);

  @override
  State<WeeklyDetailsPage> createState() => _WeeklyDetailsPageState();
}

class _WeeklyDetailsPageState extends State<WeeklyDetailsPage>
    with StopSpeechOnRouteChange{
  @override
  Widget build(BuildContext context) {
    ...
    final initialWeek =
        (widget.currentWeek ?? pregnancyController.pregnancyWeekNumber.value)
